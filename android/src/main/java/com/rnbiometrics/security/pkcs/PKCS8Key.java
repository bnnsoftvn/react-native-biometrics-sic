...
package com.rnbiometrics.security.pkcs;

import com.rnbiometrics.security.util.DerOutputStream;
import com.rnbiometrics.security.x509.AlgorithmId;
...
public class PKCS8Key implements PrivateKey {
     ...
     */
    private PKCS8Key (com.rnbiometrics.security.x509.AlgorithmId algid, byte key [])
     ...
     */
    public static PKCS8Key parse (com.rnbiometrics.security.util.DerValue in) throws IOException {
        PrivateKey key;
     ...
     */
    public static PrivateKey parseKey (com.rnbiometrics.security.util.DerValue in) throws IOException
    {
        ...
        if (!version.equals(parsedVersion)) {
            throw new IOException("version mismatch: (supported: " +
                                  com.rnbiometrics.security.util.Debug.toHexString(version) +
                                  ", parsed: " +
                                  com.rnbiometrics.security.util.Debug.toHexString(parsedVersion));
        }
     ...
     */
    static PrivateKey buildPKCS8Key (com.rnbiometrics.security.x509.AlgorithmId algid, byte[] key)
    throws IOException, InvalidKeyException
    {
         ...
         * key factory.
         */
        com.rnbiometrics.security.util.DerOutputStream pkcs8EncodedKeyStream = new com.rnbiometrics.security.util.DerOutputStream();
    ...
    public byte[] encode() throws InvalidKeyException {
        if (encodedKey == null) {
            try {
                com.rnbiometrics.security.util.DerOutputStream out;

                out = new com.rnbiometrics.security.util.DerOutputStream();
                encode (out);
    ...
    public void decode(InputStream in) throws InvalidKeyException
    {
        ...
        try {
            ...
            if (!version.equals(this.version)) {
                throw new IOException("version mismatch: (supported: " +
                                      com.rnbiometrics.security.util.Debug.toHexString(this.version) +
                                      ", parsed: " +
                                      com.rnbiometrics.security.util.Debug.toHexString(version));
            }
     ...
     */
    static void encode(com.rnbiometrics.security.util.DerOutputStream out, com.rnbiometrics.security.x509.AlgorithmId algid, byte[] key)
        throws IOException {
