 ...
 */
public class OtherName implements com.rnbiometrics.security.x509.GeneralNameInterface {

    private String name;
    private com.rnbiometrics.security.util.ObjectIdentifier oid;
    private byte[] nameValue = null;
    private com.rnbiometrics.security.x509.GeneralNameInterface gni = null;
     ...
     */
    public OtherName(com.rnbiometrics.security.util.DerValue derValue) throws IOException {
        com.rnbiometrics.security.util.DerInputStream in = derValue.toDerInputStream();
     ...
     */
    public com.rnbiometrics.security.util.ObjectIdentifier getOID() {
     ...
     */
    private com.rnbiometrics.security.x509.GeneralNameInterface getGNI(com.rnbiometrics.security.util.ObjectIdentifier oid, byte[] nameValue)
            throws IOException {
        try {
            ...
            com.rnbiometrics.security.x509.GeneralNameInterface gni =
                       (com.rnbiometrics.security.x509.GeneralNameInterface)cons.newInstance(passed);
            return gni;
        } catch (Exception e) {
     ...
     */
    public int getType() {
        return com.rnbiometrics.security.x509.GeneralNameInterface.NAME_ANY;
    }
    ...
    public void encode(com.rnbiometrics.security.util.DerOutputStream out) throws IOException {
        if (gni != null) {
            ...
            tmp.putOID(oid);
            tmp.write(com.rnbiometrics.security.util.DerValue.createTag(com.rnbiometrics.security.util.DerValue.TAG_CONTEXT, true, TAG_VALUE), nameValue);
    ...
    public boolean equals(Object other) {
        ...
        com.rnbiometrics.security.x509.GeneralNameInterface otherGNI = null;
        try {
