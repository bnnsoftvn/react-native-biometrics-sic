...
implements CertAttrSet<String> {
    ...
    throws IOException {
        id = new com.rnbiometrics.security.x509.KeyIdentifier(octetString);

        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.SubjectKey_Id;
        this.critical = false;
        encodeThis();
    }
    ...
    throws IOException {
        ...
        com.rnbiometrics.security.util.DerValue val = new DerValue(this.extensionValue);
        this.id = new com.rnbiometrics.security.x509.KeyIdentifier(val);
    }
