...
public class CertificatePolicyId {
    private com.rnbiometrics.security.util.ObjectIdentifier id;
     ...
     */
    public CertificatePolicyId(com.rnbiometrics.security.util.ObjectIdentifier id) {
        this.id = id;
    }
     ...
     */
    public CertificatePolicyId(com.rnbiometrics.security.util.DerValue val) throws IOException {
        this.id = val.getOID();
    }
