...
public class SubjectInfoAccessExtension extends Extension
     ...
     */
    private List<com.rnbiometrics.security.x509.AccessDescription> accessDescriptions;
    ...
    public SubjectInfoAccessExtension(
            List<com.rnbiometrics.security.x509.AccessDescription> accessDescriptions) throws IOException {
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.SubjectInfoAccess_Id;
        this.critical = false;
    ...
    public SubjectInfoAccessExtension(Boolean critical, Object value)
        ...
        accessDescriptions = new ArrayList<com.rnbiometrics.security.x509.AccessDescription>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            com.rnbiometrics.security.x509.AccessDescription accessDescription = new com.rnbiometrics.security.x509.AccessDescription(seq);
     ...
     */
    public List<com.rnbiometrics.security.x509.AccessDescription> getAccessDescriptions() {
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(DESCRIPTIONS)) {
            ...
            accessDescriptions = (List<com.rnbiometrics.security.x509.AccessDescription>)obj;
        } else {
