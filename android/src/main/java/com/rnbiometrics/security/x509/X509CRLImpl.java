 ...
 * @see X509CRL
 */
public class X509CRLImpl extends X509CRL implements com.rnbiometrics.security.util.DerEncoder {
    ...
    private com.rnbiometrics.security.x509.AlgorithmId sigAlgId = null; // sig alg in CRL

    // crl information
    private int              version;
    private com.rnbiometrics.security.x509.AlgorithmId infoSigAlgId; // sig alg in "to-be-signed" crl
    private com.rnbiometrics.security.x509.X500Name issuer = null;
    private X500Principal    issuerPrincipal = null;
    private Date             thisUpdate = null;
    private Date             nextUpdate = null;
    private Map<X509IssuerSerial,X509CRLEntry> revokedCerts = new LinkedHashMap<X509IssuerSerial,X509CRLEntry>();
    private com.rnbiometrics.security.x509.CRLExtensions extensions = null;
    ...
    public X509CRLImpl(byte[] crlData) throws CRLException {
        try {
            parse(new com.rnbiometrics.security.util.DerValue(crlData));
        } catch (IOException e) {
            signedCRL = null;
     ...
     * @exception CRLException on parsing errors.
     */
    public X509CRLImpl(com.rnbiometrics.security.util.DerValue val) throws CRLException {
        try {
            parse(val);
        } catch (IOException e) {
            signedCRL = null;
    ...
    public X509CRLImpl(InputStream inStrm) throws CRLException {
        try {
            parse(new com.rnbiometrics.security.util.DerValue(inStrm));
        } catch (IOException e) {
            signedCRL = null;
            throw new CRLException("Parsing error: " + e.getMessage());
        }
     ...
     */
    public X509CRLImpl(com.rnbiometrics.security.x509.X500Name issuer, Date thisDate, Date nextDate) {
        this.issuer = issuer;
        ...
        throws CRLException
    {
        ...
        if (badCerts != null) {
            ...
            for (int i = 0; i < badCerts.length; i++) {
                com.rnbiometrics.security.x509.X509CRLEntryImpl badCert = (com.rnbiometrics.security.x509.X509CRLEntryImpl)badCerts[i];
                try {
     ...
     */
    public X509CRLImpl(com.rnbiometrics.security.x509.X500Name issuer, Date thisDate, Date nextDate,
                       X509CRLEntry[] badCerts, com.rnbiometrics.security.x509.CRLExtensions crlExts)
        throws CRLException
    {
    ...
    public void encodeInfo(OutputStream out) throws CRLException {
        try {
            ...
            com.rnbiometrics.security.util.DerOutputStream rCerts = new com.rnbiometrics.security.util.DerOutputStream();
            ...
            if (!revokedCerts.isEmpty()) {
                for (X509CRLEntry entry : revokedCerts.values()) {
                    ((com.rnbiometrics.security.x509.X509CRLEntryImpl)entry).encode(rCerts);
                }
                tmp.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, rCerts);
            }
    ...
    throws CRLException, NoSuchAlgorithmException, InvalidKeyException,
        ...
        try {
            ...
            sigAlgId = com.rnbiometrics.security.x509.AlgorithmId.get(sigEngine.getAlgorithm());
    ...
    public String toString() {
        ...
        if (extensions != null) {
            Collection<com.rnbiometrics.security.x509.Extension> allExts = extensions.getAllExtensions();
            Object[] objs = allExts.toArray();
            sb.append("\nCRL Extensions: " + objs.length);
            for (int i = 0; i < objs.length; i++) {
                sb.append("\n[" + (i+1) + "]: ");
                com.rnbiometrics.security.x509.Extension ext = (com.rnbiometrics.security.x509.Extension)objs[i];
                try {
                   if (com.rnbiometrics.security.x509.OIDMap.getClass(ext.getExtensionId()) == null) {
    ...
    public String getSigAlgOID() {
        if (sigAlgId == null)
            return null;
        com.rnbiometrics.security.util.ObjectIdentifier oid = sigAlgId.getOID();
        return oid.toString();
    }
     ...
     */
    public com.rnbiometrics.security.x509.AlgorithmId getSigAlgId() {
        return sigAlgId;
    }
     ...
     */
    public com.rnbiometrics.security.x509.KeyIdentifier getAuthKeyId() throws IOException {
        com.rnbiometrics.security.x509.AuthorityKeyIdentifierExtension aki = getAuthKeyIdExtension();
        if (aki != null) {
            com.rnbiometrics.security.x509.KeyIdentifier keyId = (KeyIdentifier)aki.get(aki.KEY_ID);
            return keyId;
        } else {
            return null;
        }
     ...
     * @throws IOException on error
     */
    public com.rnbiometrics.security.x509.AuthorityKeyIdentifierExtension getAuthKeyIdExtension()
        throws IOException {
        Object obj = getExtension(com.rnbiometrics.security.x509.PKIXExtensions.AuthorityKey_Id);
     ...
     * @throws IOException on error
     */
    public com.rnbiometrics.security.x509.CRLNumberExtension getCRLNumberExtension() throws IOException {
        Object obj = getExtension(com.rnbiometrics.security.x509.PKIXExtensions.CRLNumber_Id);
        return (com.rnbiometrics.security.x509.CRLNumberExtension)obj;
    }
     ...
     * @throws IOException on error
     */
    public com.rnbiometrics.security.x509.DeltaCRLIndicatorExtension getDeltaCRLIndicatorExtension()
        throws IOException {

        Object obj = getExtension(com.rnbiometrics.security.x509.PKIXExtensions.DeltaCRLIndicator_Id);
        return (com.rnbiometrics.security.x509.DeltaCRLIndicatorExtension)obj;
    }
     ...
     * @throws IOException on error
     */
    public com.rnbiometrics.security.x509.IssuerAlternativeNameExtension getIssuerAltNameExtension()
        throws IOException {
        Object obj = getExtension(com.rnbiometrics.security.x509.PKIXExtensions.IssuerAlternativeName_Id);
     ...
     * @throws IOException on error
     */
    public com.rnbiometrics.security.x509.IssuingDistributionPointExtension
    ...
    public byte[] getExtensionValue(String oid) {
        if (extensions == null)
            return null;
        try {
            String extAlias = com.rnbiometrics.security.x509.OIDMap.getName(new com.rnbiometrics.security.util.ObjectIdentifier(oid));
            com.rnbiometrics.security.x509.Extension crlExt = null;

            if (extAlias == null) { // may be unknown
                com.rnbiometrics.security.util.ObjectIdentifier findOID = new com.rnbiometrics.security.util.ObjectIdentifier(oid);
                com.rnbiometrics.security.x509.Extension ex = null;
                com.rnbiometrics.security.util.ObjectIdentifier inCertOID;
     ...
     * @throws IOException on error
     */
    public Object getExtension(com.rnbiometrics.security.util.ObjectIdentifier oid) {
        if (extensions == null)
            return null;
     ...
     */
    private void parse(com.rnbiometrics.security.util.DerValue val) throws CRLException, IOException {
        // check if can over write the certificate
        if (readOnly)
            throw new CRLException("cannot over-write existing CRL");

        if ( val.getData() == null || val.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence)
            throw new CRLException("Invalid DER-encoded CRL data");

        signedCRL = val.toByteArray();
        com.rnbiometrics.security.util.DerValue seq[] = new com.rnbiometrics.security.util.DerValue[3];
        ...
        sigAlgId = com.rnbiometrics.security.x509.AlgorithmId.parse(seq[1]);
        ...
        com.rnbiometrics.security.util.DerInputStream derStrm = seq[0].data;
        ...
        if (nextByte == com.rnbiometrics.security.util.DerValue.tag_Integer) {
        ...
        // signature
        com.rnbiometrics.security.x509.AlgorithmId tmpId = AlgorithmId.parse(tmp);
        ...
        // issuer
        issuer = new com.rnbiometrics.security.x509.X500Name(derStrm);
        if (issuer.isEmpty()) {
        ...
        nextByte = (byte)derStrm.peekByte();
        if (nextByte == com.rnbiometrics.security.util.DerValue.tag_UtcTime) {
            thisUpdate = derStrm.getUTCTime();
        } else if (nextByte == com.rnbiometrics.security.util.DerValue.tag_GeneralizedTime) {
        ...
        nextByte = (byte)derStrm.peekByte();
        if ((nextByte == com.rnbiometrics.security.util.DerValue.tag_SequenceOf)
            && (! ((nextByte & 0x0c0) == 0x080))) {
            com.rnbiometrics.security.util.DerValue[] badCerts = derStrm.getSequence(4);

            X500Principal crlIssuer = getIssuerX500Principal();
            X500Principal badCertIssuer = crlIssuer;
            for (int i = 0; i < badCerts.length; i++) {
                com.rnbiometrics.security.x509.X509CRLEntryImpl entry = new com.rnbiometrics.security.x509.X509CRLEntryImpl(badCerts[i]);
    ...
    private X500Principal getCertIssuer(X509CRLEntryImpl entry,
        ...
        com.rnbiometrics.security.x509.CertificateIssuerExtension ciExt =
            entry.getCertificateIssuerExtension();
        if (ciExt != null) {
            com.rnbiometrics.security.x509.GeneralNames names = (GeneralNames)
                ciExt.get(CertificateIssuerExtension.ISSUER);
            com.rnbiometrics.security.x509.X500Name issuerDN = (X500Name) names.get(0).getName();
