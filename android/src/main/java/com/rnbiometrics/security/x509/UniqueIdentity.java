...
public class UniqueIdentity {
    ...
    private com.rnbiometrics.security.util.BitArray id;
     ...
     */
    public UniqueIdentity(com.rnbiometrics.security.util.BitArray id) {
        this.id = id;
    }
     ...
     */
    public UniqueIdentity(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public UniqueIdentity(com.rnbiometrics.security.util.DerValue derVal) throws IOException {
        id = derVal.getUnalignedBitString(true);
    }
     ...
     */
    public void encode(com.rnbiometrics.security.util.DerOutputStream out, byte tag) throws IOException {
