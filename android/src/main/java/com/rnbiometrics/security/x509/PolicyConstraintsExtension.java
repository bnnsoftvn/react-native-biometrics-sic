...
implements CertAttrSet<String> {
    ...
    private void encodeThis() throws IOException {
        ...
        seq.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, tagged);
    ...
    throws IOException {
        ...
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.PolicyConstraints_Id;
    ...
    throws IOException {
        ...
        com.rnbiometrics.security.util.DerInputStream in = val.data;
        while (in != null && in.available() != 0) {
            com.rnbiometrics.security.util.DerValue next = in.getDerValue();
            ...
            if (next.isContextSpecific(TAG_REQUIRE) && !next.isConstructed()) {
                ...
                next.resetTag(com.rnbiometrics.security.util.DerValue.tag_Integer);
