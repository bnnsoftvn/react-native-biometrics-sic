...
implements CertAttrSet<String> {
     ...
     */
    private List<com.rnbiometrics.security.x509.PolicyInformation> certPolicies;
    ...
    private void encodeThis() throws IOException {
        if (certPolicies == null || certPolicies.isEmpty()) {
            ...
            for (com.rnbiometrics.security.x509.PolicyInformation info : certPolicies) {
                info.encode(tmp);
            }
     ...
     */
    public CertificatePoliciesExtension(List<com.rnbiometrics.security.x509.PolicyInformation> certPolicies)
    throws IOException {
    ...
    public CertificatePoliciesExtension(Boolean critical,
            List<com.rnbiometrics.security.x509.PolicyInformation> certPolicies) throws IOException {
        this.certPolicies = certPolicies;
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.CertificatePolicies_Id;
    ...
    throws IOException {
        ...
        certPolicies = new ArrayList<com.rnbiometrics.security.x509.PolicyInformation>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            com.rnbiometrics.security.x509.PolicyInformation policy = new com.rnbiometrics.security.x509.PolicyInformation(seq);
