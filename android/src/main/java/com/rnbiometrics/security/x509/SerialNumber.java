...
public class SerialNumber {
     ...
     */
    public SerialNumber(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public SerialNumber(com.rnbiometrics.security.util.DerValue val) throws IOException {
        construct(val);
    }
    ...
    public String toString() {
        return ("SerialNumber: [" + com.rnbiometrics.security.util.Debug.toHexString(serialNum) + "]");
    }
