...
public class CertificateIssuerUniqueIdentity implements CertAttrSet<String> {
     ...
     */
    public CertificateIssuerUniqueIdentity(com.rnbiometrics.security.x509.UniqueIdentity id) {
        this.id = id;
    }
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateIssuerUniqueIdentity(com.rnbiometrics.security.util.DerValue val)
    throws IOException {
        id = new com.rnbiometrics.security.x509.UniqueIdentity(val);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        id.encode(tmp, com.rnbiometrics.security.util.DerValue.createTag(com.rnbiometrics.security.util.DerValue.TAG_CONTEXT,false,(byte)1));
