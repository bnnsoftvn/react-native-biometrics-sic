 ...
 * @see PKCS10
 * @see com.rnbiometrics.security.x509.X509CertImpl
 */
public final class CertAndKeyGen {
     ...
     */
    public com.rnbiometrics.security.x509.X509Key getPublicKey()
    {
        if (!(publicKey instanceof com.rnbiometrics.security.x509.X509Key)) {
            return null;
        }
    ...
    public X509Certificate getSelfCertificate (
            com.rnbiometrics.security.x509.X500Name myname, Date firstDate, long validity)
    throws CertificateException, InvalidKeyException, SignatureException,
        NoSuchAlgorithmException, NoSuchProviderException
    {
        com.rnbiometrics.security.x509.X509CertImpl cert;
        Date            lastDate;
        ...
        try {
            ...
            com.rnbiometrics.security.x509.CertificateValidity interval =
                                   new CertificateValidity(firstDate,lastDate);

            com.rnbiometrics.security.x509.X509CertInfo info = new com.rnbiometrics.security.x509.X509CertInfo();
            // Add all mandatory attributes
            info.set(com.rnbiometrics.security.x509.X509CertInfo.VERSION,
                     new com.rnbiometrics.security.x509.CertificateVersion(CertificateVersion.V3));
            info.set(com.rnbiometrics.security.x509.X509CertInfo.SERIAL_NUMBER, new CertificateSerialNumber(
                    new java.util.Random().nextInt() & 0x7fffffff));
            com.rnbiometrics.security.x509.AlgorithmId algID = AlgorithmId.getAlgorithmId(sigAlg);
            info.set(com.rnbiometrics.security.x509.X509CertInfo.ALGORITHM_ID,
                     new CertificateAlgorithmId(algID));
            info.set(com.rnbiometrics.security.x509.X509CertInfo.SUBJECT, new CertificateSubjectName(myname));
            info.set(com.rnbiometrics.security.x509.X509CertInfo.KEY, new CertificateX509Key(publicKey));
            info.set(com.rnbiometrics.security.x509.X509CertInfo.VALIDITY, interval);
    ...
    // Keep the old method
    public X509Certificate getSelfCertificate (com.rnbiometrics.security.x509.X500Name myname, long validity)
    throws CertificateException, InvalidKeyException, SignatureException,
        NoSuchAlgorithmException, NoSuchProviderException
    {
