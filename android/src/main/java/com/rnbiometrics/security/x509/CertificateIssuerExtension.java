...
public class CertificateIssuerExtension extends Extension
    ...
    private com.rnbiometrics.security.x509.GeneralNames names;
     ...
     */
    public CertificateIssuerExtension(com.rnbiometrics.security.x509.GeneralNames issuer) throws IOException {
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.CertificateIssuer_Id;
        this.critical = true;
        this.names = issuer;
        encodeThis();
    }
    ...
    public CertificateIssuerExtension(Boolean critical, Object value)
        ...
        this.names = new com.rnbiometrics.security.x509.GeneralNames(val);
    }
