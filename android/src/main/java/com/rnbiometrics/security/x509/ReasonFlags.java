...
public class ReasonFlags {
    ...
    public ReasonFlags(byte[] reasons) {
        bitString = new com.rnbiometrics.security.util.BitArray(reasons.length*8, reasons).toBooleanArray();
    }
     ...
     * @param reasons the bits to be set for the ReasonFlags.
     */
    public ReasonFlags(com.rnbiometrics.security.util.BitArray reasons) {
     ...
     * @exception IOException on decoding errors.
     */
    public ReasonFlags(com.rnbiometrics.security.util.DerValue derVal) throws IOException {
        this.bitString = derVal.getUnalignedBitString(true).toBooleanArray();
    }
    ...
    public void encode(com.rnbiometrics.security.util.DerOutputStream out) throws IOException {
        out.putTruncatedUnalignedBitString(new com.rnbiometrics.security.util.BitArray(this.bitString));
    }
