...
implements CertAttrSet<String> {
     ...
     */
    public static com.rnbiometrics.security.util.ObjectIdentifier NetscapeCertType_Id;

    static {
        try {
            NetscapeCertType_Id = new com.rnbiometrics.security.util.ObjectIdentifier(CertType_data);
    ...
    public boolean[] getKeyUsageMappedBits() {
        com.rnbiometrics.security.x509.KeyUsageExtension keyUsage = new KeyUsageExtension();
