...
public class X509CRLEntryImpl extends X509CRLEntry {
    ...
    private com.rnbiometrics.security.x509.SerialNumber serialNumber = null;
    ...
    public X509CRLEntryImpl(BigInteger num, Date date) {
        this.serialNumber = new com.rnbiometrics.security.x509.SerialNumber(num);
     ...
     */
    public X509CRLEntryImpl(BigInteger num, Date date,
                           com.rnbiometrics.security.x509.CRLExtensions crlEntryExts) {
        this.serialNumber = new com.rnbiometrics.security.x509.SerialNumber(num);
        this.revocationDate = date;
    ...
    public X509CRLEntryImpl(byte[] revokedCert) throws CRLException {
        try {
            parse(new com.rnbiometrics.security.util.DerValue(revokedCert));
        } catch (IOException e) {
     ...
     */
    public void encode(com.rnbiometrics.security.util.DerOutputStream outStrm) throws CRLException {
        try {
            if (revokedCert == null) {
                ...
                com.rnbiometrics.security.util.DerOutputStream seq = new DerOutputStream();
    ...
    public byte[] getEncoded() throws CRLException {
        if (revokedCert == null)
            this.encode(new com.rnbiometrics.security.util.DerOutputStream());
    ...
    public CRLReason getRevocationReason() {
        com.rnbiometrics.security.x509.Extension ext = getExtension(com.rnbiometrics.security.x509.PKIXExtensions.ReasonCode_Id);
        if (ext == null) {
            return null;
        }
        com.rnbiometrics.security.x509.CRLReasonCodeExtension rcExt = (com.rnbiometrics.security.x509.CRLReasonCodeExtension) ext;
    ...
    public static CRLReason getRevocationReason(X509CRLEntry crlEntry) {
        try {
            ...
            com.rnbiometrics.security.x509.CRLReasonCodeExtension rcExt =
                new com.rnbiometrics.security.x509.CRLReasonCodeExtension(Boolean.FALSE, data);
            return rcExt.getReasonCode();
    ...
    public Integer getReasonCode() throws IOException {
        Object obj = getExtension(com.rnbiometrics.security.x509.PKIXExtensions.ReasonCode_Id);
        if (obj == null)
            return null;
        com.rnbiometrics.security.x509.CRLReasonCodeExtension reasonCode = (CRLReasonCodeExtension)obj;
    ...
    public byte[] getExtensionValue(String oid) {
        ...
        try {
            ...
            if (extAlias == null) { // may be unknown
                ...
                for (Enumeration<com.rnbiometrics.security.x509.Extension> e = extensions.getElements();
                     e.hasMoreElements();) {
                    ex = e.nextElement();
    ...
    private void parse(com.rnbiometrics.security.util.DerValue derVal)
    throws CRLException, IOException {

        if (derVal.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence) {
        ...
        // serial number
        com.rnbiometrics.security.util.DerInputStream in = derVal.toDerInputStream();
        com.rnbiometrics.security.util.DerValue val = in.getDerValue();
        this.serialNumber = new SerialNumber(val);

        // revocationDate
        int nextByte = derVal.data.peekByte();
        if ((byte)nextByte == com.rnbiometrics.security.util.DerValue.tag_UtcTime) {
            this.revocationDate = derVal.data.getUTCTime();
        } else if ((byte)nextByte == com.rnbiometrics.security.util.DerValue.tag_GeneralizedTime) {
     ...
     */
    com.rnbiometrics.security.x509.CertificateIssuerExtension getCertificateIssuerExtension() {
