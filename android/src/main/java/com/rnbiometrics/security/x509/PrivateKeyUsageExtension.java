...
implements CertAttrSet<String> {
    ...
    private void encodeThis() throws IOException {
        ...
        com.rnbiometrics.security.util.DerOutputStream tagged = new com.rnbiometrics.security.util.DerOutputStream();
        if (notBefore != null) {
            ...
            tagged.writeImplicit(com.rnbiometrics.security.util.DerValue.createTag(com.rnbiometrics.security.util.DerValue.TAG_CONTEXT,
    ...
    throws IOException {
        ...
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.PrivateKeyUsage_Id;
        this.critical = false;
        encodeThis();
    }
    ...
    throws CertificateException, IOException {
        ...
        com.rnbiometrics.security.util.DerInputStream str = new com.rnbiometrics.security.util.DerInputStream(this.extensionValue);
        com.rnbiometrics.security.util.DerValue[] seq = str.getSequence(2);
        ...
        for (int i = 0; i < seq.length; i++) {
            ...
            if (opt.isContextSpecific(TAG_BEFORE) &&
                ...
                opt.resetTag(com.rnbiometrics.security.util.DerValue.tag_GeneralizedTime);
                str = new com.rnbiometrics.security.util.DerInputStream(opt.toByteArray());
