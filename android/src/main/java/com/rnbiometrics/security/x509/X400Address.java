 ...
 */
public class X400Address implements com.rnbiometrics.security.x509.GeneralNameInterface {
     ...
     */
    public int getType() {
        return (com.rnbiometrics.security.x509.GeneralNameInterface.NAME_X400);
    }
