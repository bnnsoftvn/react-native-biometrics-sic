...
public class Extension /* implements java.security.cert.Extension */ {
     ...
     */
    public Extension(com.rnbiometrics.security.util.DerValue derVal) throws IOException {
    ...
    public Extension(ObjectIdentifier extensionId, boolean critical,
        ...
        // and length
        com.rnbiometrics.security.util.DerValue inDerVal = new com.rnbiometrics.security.util.DerValue(extensionValue);
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        com.rnbiometrics.security.util.DerOutputStream dos1 = new com.rnbiometrics.security.util.DerOutputStream();
        com.rnbiometrics.security.util.DerOutputStream dos2 = new com.rnbiometrics.security.util.DerOutputStream();
        ...
        dos2.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, dos1);
    ...
    public void encode(com.rnbiometrics.security.util.DerOutputStream out) throws IOException {
        ...
        com.rnbiometrics.security.util.DerOutputStream dos = new com.rnbiometrics.security.util.DerOutputStream();
        ...
        out.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, dos);
    }
