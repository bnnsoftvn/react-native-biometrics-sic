...
public class CertificateSubjectName implements CertAttrSet<String> {
     ...
     */
    public CertificateSubjectName(com.rnbiometrics.security.x509.X500Name name) {
        this.dnName = name;
    }
     ...
     */
    public CertificateSubjectName(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
