...
implements CertAttrSet<String> {
    ...
    public CRLNumberExtension(int crlNum) throws IOException {
        this(com.rnbiometrics.security.x509.PKIXExtensions.CRLNumber_Id, false, BigInteger.valueOf(crlNum),
        NAME, LABEL);
    }
    ...
    public CRLNumberExtension(BigInteger crlNum) throws IOException {
        this(com.rnbiometrics.security.x509.PKIXExtensions.CRLNumber_Id, false, crlNum, NAME, LABEL);
    }

    /**
     * Creates the extension (also called by the subclass).
     */
    protected CRLNumberExtension(com.rnbiometrics.security.util.ObjectIdentifier extensionId,
    ...
    throws IOException {
        this(com.rnbiometrics.security.x509.PKIXExtensions.CRLNumber_Id, critical, value, NAME, LABEL);
    }
    ...
    public String toString() {
        String s = super.toString() + extensionLabel + ": " +
                   ((crlNumber == null) ? "" : com.rnbiometrics.security.util.Debug.toHexString(crlNumber))
                   + "\n";
        return (s);
    }
