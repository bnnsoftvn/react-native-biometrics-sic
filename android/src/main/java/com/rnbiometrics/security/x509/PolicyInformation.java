...
public class PolicyInformation {
    ...
    /* The policy OID */
    private com.rnbiometrics.security.x509.CertificatePolicyId policyIdentifier;
     ...
     */
    public PolicyInformation(com.rnbiometrics.security.x509.CertificatePolicyId policyIdentifier,
    ...
    public PolicyInformation(DerValue val) throws IOException {
        ...
        policyIdentifier = new com.rnbiometrics.security.x509.CertificatePolicyId(val.data.getDerValue());
     ...
     */
    public com.rnbiometrics.security.x509.CertificatePolicyId getPolicyIdentifier() {
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(ID)) {
            if (obj instanceof com.rnbiometrics.security.x509.CertificatePolicyId)
