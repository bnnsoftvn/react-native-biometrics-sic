 ...
 */
public class EDIPartyName implements com.rnbiometrics.security.x509.GeneralNameInterface {
     ...
     */
    public EDIPartyName(com.rnbiometrics.security.util.DerValue derValue) throws IOException {
        com.rnbiometrics.security.util.DerInputStream in = new com.rnbiometrics.security.util.DerInputStream(derValue.toByteArray());
        com.rnbiometrics.security.util.DerValue[] seq = in.getSequence(2);
        ...
        for (int i = 0; i < len; i++) {
            com.rnbiometrics.security.util.DerValue opt = seq[i];
     ...
     */
    public int getType() {
        return (com.rnbiometrics.security.x509.GeneralNameInterface.NAME_EDI);
    }
    ...
    public void encode(com.rnbiometrics.security.util.DerOutputStream out) throws IOException {
        com.rnbiometrics.security.util.DerOutputStream tagged = new DerOutputStream();
        com.rnbiometrics.security.util.DerOutputStream tmp = new com.rnbiometrics.security.util.DerOutputStream();

        if (assigner != null) {
            com.rnbiometrics.security.util.DerOutputStream tmp2 = new com.rnbiometrics.security.util.DerOutputStream();
            // XXX - shd check is chars fit into PrintableString
            tmp2.putPrintableString(assigner);
            tagged.write(com.rnbiometrics.security.util.DerValue.createTag(com.rnbiometrics.security.util.DerValue.TAG_CONTEXT,
        ...
        out.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, tagged);
    }
