 ...
 * @see GeneralName
 * @see GeneralNames
 * @see com.rnbiometrics.security.x509.GeneralNameInterface
 */
public class URIName implements com.rnbiometrics.security.x509.GeneralNameInterface {

    // private attributes
    private URI uri;
    private String host;
    private com.rnbiometrics.security.x509.DNSName hostDNS;
    private com.rnbiometrics.security.x509.IPAddressName hostIP;
    ...
    public URIName(String name) throws IOException {
        ...
        if (host != null) {
            if (host.charAt(0) == '[') {
                ...
                try {
                    hostIP = new com.rnbiometrics.security.x509.IPAddressName(ipV6Host);
                ...
                try {
                    hostDNS = new com.rnbiometrics.security.x509.DNSName(host);
                } catch (IOException ioe) {
     ...
     */
    public static URIName nameConstraint(com.rnbiometrics.security.util.DerValue value) throws IOException {
        URI uri;
        ...
        if (uri.getScheme() == null) {
            ...
            try {
                com.rnbiometrics.security.x509.DNSName hostDNS;
                if (host.charAt(0) == '.') {
                    hostDNS = new com.rnbiometrics.security.x509.DNSName(host.substring(1));
                } else {
                    hostDNS = new com.rnbiometrics.security.x509.DNSName(host);
                }
    ...
    URIName(URI uri, String host, com.rnbiometrics.security.x509.DNSName hostDNS) {
        this.uri = uri;
        this.host = host;
     ...
     */
    public int getType() {
        return com.rnbiometrics.security.x509.GeneralNameInterface.NAME_URI;
    }
    ...
    public int constrains(GeneralNameInterface inputName)
        ...
        if (inputName == null) {
            ...
            if (otherHost.equalsIgnoreCase(host)) {
                ...
                if ((hostDNS == null) ||
                    !(otherHostObject instanceof com.rnbiometrics.security.x509.DNSName)) {
                    ...
                    com.rnbiometrics.security.x509.DNSName otherDNS = (com.rnbiometrics.security.x509.DNSName) otherHostObject;
    ...
    public int subtreeDepth() throws UnsupportedOperationException {
        com.rnbiometrics.security.x509.DNSName dnsName = null;
        try {
