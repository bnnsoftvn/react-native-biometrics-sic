...
public class CRLExtensions {
     ...
     */
    public CRLExtensions(com.rnbiometrics.security.util.DerInputStream in) throws CRLException {
        init(in);
    }

    // helper routine
    private void init(com.rnbiometrics.security.util.DerInputStream derStrm) throws CRLException {
        try {
            com.rnbiometrics.security.util.DerInputStream str = derStrm;

            byte nextByte = (byte)derStrm.peekByte();
            // check for context specific byte 0; skip it
            if (((nextByte & 0x0c0) == 0x080) &&
                ((nextByte & 0x01f) == 0x000)) {
                com.rnbiometrics.security.util.DerValue val = str.getDerValue();
                str = val.data;
            }

            com.rnbiometrics.security.util.DerValue[] exts = str.getSequence(5);
    ...
    private void parseExtension(com.rnbiometrics.security.x509.Extension ext) throws CRLException {
        try {
            ...
            com.rnbiometrics.security.x509.CertAttrSet crlExt = (com.rnbiometrics.security.x509.CertAttrSet)cons.newInstance(passed);
            if (map.put(crlExt.getName(), (com.rnbiometrics.security.x509.Extension)crlExt) != null) {
                throw new CRLException("Duplicate extensions not allowed");
            }
    ...
    throws CRLException {
        try {
            ...
            if (isExplicit)
                tmp.write(com.rnbiometrics.security.util.DerValue.createTag(DerValue.TAG_CONTEXT,
                                             true, (byte)0), seq);
            else
                tmp = seq;
     ...
     */
    public com.rnbiometrics.security.x509.Extension get(String alias) {
        com.rnbiometrics.security.x509.X509AttributeName attr = new X509AttributeName(alias);
        String name;
    ...
    public void set(String alias, Object obj) {
        map.put(alias, (com.rnbiometrics.security.x509.Extension)obj);
    }
