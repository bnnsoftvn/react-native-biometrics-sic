...
implements CertAttrSet<String> {
     ...
     */
    public SubjectAlternativeNameExtension(com.rnbiometrics.security.x509.GeneralNames names)
    throws IOException {
     ...
     * @exception IOException on error.
     */
    public SubjectAlternativeNameExtension(Boolean critical, com.rnbiometrics.security.x509.GeneralNames names)
    throws IOException {
        this.names = names;
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.SubjectAlternativeName_Id;
    ...
    public SubjectAlternativeNameExtension() {
        extensionId = com.rnbiometrics.security.x509.PKIXExtensions.SubjectAlternativeName_Id;
        critical = false;
        names = new com.rnbiometrics.security.x509.GeneralNames();
    }
    ...
    throws IOException {
        ...
        names = new com.rnbiometrics.security.x509.GeneralNames(val);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        com.rnbiometrics.security.util.DerOutputStream tmp = new DerOutputStream();
