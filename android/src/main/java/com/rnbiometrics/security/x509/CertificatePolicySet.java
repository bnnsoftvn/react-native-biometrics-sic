...
public class CertificatePolicySet {
    ...
    private final Vector<com.rnbiometrics.security.x509.CertificatePolicyId> ids;
     ...
     */
    public CertificatePolicySet(Vector<com.rnbiometrics.security.x509.CertificatePolicyId> ids) {
        this.ids = ids;
    }
     ...
     */
    public CertificatePolicySet(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
        ids = new Vector<com.rnbiometrics.security.x509.CertificatePolicyId>();
        com.rnbiometrics.security.util.DerValue[] seq = in.getSequence(5);

        for (int i = 0; i < seq.length; i++) {
            com.rnbiometrics.security.x509.CertificatePolicyId id = new com.rnbiometrics.security.x509.CertificatePolicyId(seq[i]);
            ids.addElement(id);
        }
    }
