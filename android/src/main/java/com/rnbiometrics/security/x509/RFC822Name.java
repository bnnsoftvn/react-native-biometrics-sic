 ...
 */
public class RFC822Name implements com.rnbiometrics.security.x509.GeneralNameInterface
{
    private String name;
     ...
     */
    public int getType() {
        return (com.rnbiometrics.security.x509.GeneralNameInterface.NAME_RFC822);
    }
     ...
     */
    public int constrains(com.rnbiometrics.security.x509.GeneralNameInterface inputName) throws UnsupportedOperationException {
        int constraintType;
        if (inputName == null)
