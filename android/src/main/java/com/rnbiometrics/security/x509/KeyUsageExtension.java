...
implements CertAttrSet<String> {
    ...
    private void encodeThis() throws IOException {
        ...
        os.putTruncatedUnalignedBitString(new com.rnbiometrics.security.util.BitArray(this.bitString));
    ...
    public KeyUsageExtension(byte[] bitString) throws IOException {
        this.bitString =
            new com.rnbiometrics.security.util.BitArray(bitString.length*8,bitString).toBooleanArray();
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.KeyUsage_Id;
        this.critical = true;
        encodeThis();
    }
     ...
     * @param bitString the bits to be set for the extension.
     */
    public KeyUsageExtension(com.rnbiometrics.security.util.BitArray bitString) throws IOException {
    ...
    throws IOException {
        ...
        if (extValue[0] == com.rnbiometrics.security.util.DerValue.tag_OctetString) {
            this.extensionValue = new com.rnbiometrics.security.util.DerValue(extValue).getOctetString();
        } else {
    ...
    public void encode(OutputStream out) throws IOException {
       DerOutputStream tmp = new com.rnbiometrics.security.util.DerOutputStream();
