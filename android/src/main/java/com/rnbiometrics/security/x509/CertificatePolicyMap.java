...
public class CertificatePolicyMap {
    private com.rnbiometrics.security.x509.CertificatePolicyId issuerDomain;
    private com.rnbiometrics.security.x509.CertificatePolicyId subjectDomain;
     ...
     */
    public CertificatePolicyMap(com.rnbiometrics.security.x509.CertificatePolicyId issuer,
                                com.rnbiometrics.security.x509.CertificatePolicyId subject) {
     ...
     */
    public CertificatePolicyMap(com.rnbiometrics.security.util.DerValue val) throws IOException {
        if (val.tag != DerValue.tag_Sequence) {
            throw new IOException("Invalid encoding for CertificatePolicyMap");
        }
        issuerDomain = new com.rnbiometrics.security.x509.CertificatePolicyId(val.data.getDerValue());
        subjectDomain = new com.rnbiometrics.security.x509.CertificatePolicyId(val.data.getDerValue());
    }

    /**
     * Return the issuer CA part of the policy map.
     */
    public com.rnbiometrics.security.x509.CertificatePolicyId getIssuerIdentifier() {
        return (issuerDomain);
    }
