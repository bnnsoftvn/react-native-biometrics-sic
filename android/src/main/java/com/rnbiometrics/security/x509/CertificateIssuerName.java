...
public class CertificateIssuerName implements CertAttrSet<String> {
    ...
    // Private data member
    private com.rnbiometrics.security.x509.X500Name dnName;
     ...
     */
    public CertificateIssuerName(com.rnbiometrics.security.x509.X500Name name) {
        this.dnName = name;
    }
     ...
     */
    public CertificateIssuerName(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
        dnName = new com.rnbiometrics.security.x509.X500Name(in);
    }
    ...
    public CertificateIssuerName(InputStream in) throws IOException {
        com.rnbiometrics.security.util.DerValue derVal = new com.rnbiometrics.security.util.DerValue(in);
        dnName = new com.rnbiometrics.security.x509.X500Name(derVal);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof com.rnbiometrics.security.x509.X500Name)) {
