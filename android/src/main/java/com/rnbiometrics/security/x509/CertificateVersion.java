...
public class CertificateVersion implements CertAttrSet<String> {
     ...
     */
    public CertificateVersion(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
        version = V1;
    ...
    public CertificateVersion(InputStream in) throws IOException {
        version = V1;
        DerValue derVal = new com.rnbiometrics.security.util.DerValue(in);
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateVersion(com.rnbiometrics.security.util.DerValue val) throws IOException {
        version = V1;
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        seq.write(com.rnbiometrics.security.util.DerValue.createTag(com.rnbiometrics.security.util.DerValue.TAG_CONTEXT, true, (byte)0),
                  tmp);
