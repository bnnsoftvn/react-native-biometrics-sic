...
public class X509Key implements PublicKey {
    ...
    protected com.rnbiometrics.security.x509.AlgorithmId algid;

    /**
     * The key bytes, without the algorithm information.
     * @deprecated Use the BitArray form which does not require keys to
     * be byte aligned.
     * @see X509Key#setKey(com.rnbiometrics.security.util.BitArray)
     * @see X509Key#getKey()
     */
    @Deprecated
    ...
    private com.rnbiometrics.security.util.BitArray bitStringKey = null;
     ...
     */
    private X509Key(com.rnbiometrics.security.x509.AlgorithmId algid, com.rnbiometrics.security.util.BitArray key)
     ...
     */
    protected void setKey(com.rnbiometrics.security.util.BitArray key) {
        this.bitStringKey = (com.rnbiometrics.security.util.BitArray)key.clone();
     ...
     */
    protected com.rnbiometrics.security.util.BitArray getKey() {
        /*
         ...
         */
        this.bitStringKey = new com.rnbiometrics.security.util.BitArray(
                          this.key.length * 8 - this.unusedBits,
                          this.key);

        return (com.rnbiometrics.security.util.BitArray)bitStringKey.clone();
    }
     ...
     */
    public static PublicKey parse(com.rnbiometrics.security.util.DerValue in) throws IOException
    {
        com.rnbiometrics.security.x509.AlgorithmId algorithm;
        PublicKey       subjectKey;

        if (in.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence)
            throw new IOException("corrupt subject key");

        algorithm = com.rnbiometrics.security.x509.AlgorithmId.parse(in.data.getDerValue());
        try {
     ...
     */
    static PublicKey buildX509Key(com.rnbiometrics.security.x509.AlgorithmId algid, com.rnbiometrics.security.util.BitArray key)
      throws IOException, InvalidKeyException
    {
         ...
         * key factory.
         */
        com.rnbiometrics.security.util.DerOutputStream x509EncodedKeyStream = new com.rnbiometrics.security.util.DerOutputStream();
     ...
     */
    public com.rnbiometrics.security.x509.AlgorithmId getAlgorithmId() { return algid; }
    ...
    throws InvalidKeyException
    {
        com.rnbiometrics.security.util.DerValue val;

        try {
            val = new com.rnbiometrics.security.util.DerValue(in);
            if (val.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence)
                throw new InvalidKeyException("invalid key format");

            algid = com.rnbiometrics.security.x509.AlgorithmId.parse(val.data.getDerValue());
     ...
     */
    static void encode(com.rnbiometrics.security.util.DerOutputStream out, AlgorithmId algid, com.rnbiometrics.security.util.BitArray key)
        throws IOException {
