...
public class CertificateSubjectUniqueIdentity implements CertAttrSet<String> {
    ...
    private com.rnbiometrics.security.x509.UniqueIdentity id;
     ...
     */
    public CertificateSubjectUniqueIdentity(com.rnbiometrics.security.x509.UniqueIdentity id) {
        this.id = id;
    }
     ...
     */
    public CertificateSubjectUniqueIdentity(com.rnbiometrics.security.util.DerInputStream in)
    throws IOException {
        id = new com.rnbiometrics.security.x509.UniqueIdentity(in);
    }
    ...
    throws IOException {
        com.rnbiometrics.security.util.DerValue val = new com.rnbiometrics.security.util.DerValue(in);
        id = new com.rnbiometrics.security.x509.UniqueIdentity(val);
    }
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateSubjectUniqueIdentity(com.rnbiometrics.security.util.DerValue val)
    throws IOException {
        id = new com.rnbiometrics.security.x509.UniqueIdentity(val);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        id.encode(tmp, com.rnbiometrics.security.util.DerValue.createTag(DerValue.TAG_CONTEXT,false,(byte)2));
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof com.rnbiometrics.security.x509.UniqueIdentity)) {
