...
import com.rnbiometrics.misc.HexDumpEncoder;
import com.rnbiometrics.misc.BASE64Decoder;

import com.rnbiometrics.security.provider.X509Factory;
 ...
 * @see com.rnbiometrics.security.x509.X509CertInfo
 */
public class X509CertImpl extends X509Certificate implements com.rnbiometrics.security.util.DerEncoder {
    ...
    public static final String INFO = com.rnbiometrics.security.x509.X509CertInfo.NAME;
    ...
    public static final String SUBJECT_DN = NAME + DOT + INFO + DOT +
                               com.rnbiometrics.security.x509.X509CertInfo.SUBJECT + DOT +
                               com.rnbiometrics.security.x509.CertificateSubjectName.DN_NAME;
    // x509.info.issuer.dname
    public static final String ISSUER_DN = NAME + DOT + INFO + DOT +
                               com.rnbiometrics.security.x509.X509CertInfo.ISSUER + DOT +
                               com.rnbiometrics.security.x509.CertificateIssuerName.DN_NAME;
    // x509.info.serialNumber.number
    public static final String SERIAL_ID = NAME + DOT + INFO + DOT +
                               com.rnbiometrics.security.x509.X509CertInfo.SERIAL_NUMBER + DOT +
                               com.rnbiometrics.security.x509.CertificateSerialNumber.NUMBER;
    // x509.info.key.value
    public static final String PUBLIC_KEY = NAME + DOT + INFO + DOT +
                               com.rnbiometrics.security.x509.X509CertInfo.KEY + DOT +
                               com.rnbiometrics.security.x509.CertificateX509Key.KEY;

    // x509.info.version.value
    public static final String VERSION = NAME + DOT + INFO + DOT +
                               com.rnbiometrics.security.x509.X509CertInfo.VERSION + DOT +
                               com.rnbiometrics.security.x509.CertificateVersion.VERSION;
    ...
    protected com.rnbiometrics.security.x509.X509CertInfo info = null;
    protected com.rnbiometrics.security.x509.AlgorithmId algId = null;
    ...
    public X509CertImpl(byte[] certData) throws CertificateException {
        try {
            parse(new com.rnbiometrics.security.util.DerValue(certData));
        } catch (IOException e) {
            signedCert = null;
    ...
    public X509CertImpl(InputStream in) throws CertificateException {
        ...
        com.rnbiometrics.security.util.DerValue der = null;
        ...
        try {
            ...
            try {
                ...
                inBuffered.reset();
                der = new com.rnbiometrics.security.util.DerValue(inBuffered);
     ...
     *                     encoded bytes
     */
    private com.rnbiometrics.security.util.DerValue readRFC1421Cert(InputStream in) throws IOException {
        com.rnbiometrics.security.util.DerValue der = null;
        String line = null;
            ...
            try {
                while ((line = certBufferedReader.readLine()) != null) {
                    if (line.equals(X509Factory.END_CERT)) {
                        der = new com.rnbiometrics.security.util.DerValue(decstream.toByteArray());
                        break;
                    } else {
     ...
     *              created from.
     */
    public X509CertImpl(com.rnbiometrics.security.x509.X509CertInfo certInfo) {
        this.info = certInfo;
    }
     ...
     * @exception CertificateException on parsing and initialization errors.
     */
    public X509CertImpl(com.rnbiometrics.security.util.DerValue derVal) throws CertificateException {
        try {
            parse(derVal);
        } catch (IOException e) {
            signedCert = null;
    ...
    throws CertificateException, NoSuchAlgorithmException,
        ...
        try {
            ...
            algId = com.rnbiometrics.security.x509.AlgorithmId.get(sigEngine.getAlgorithm());

            com.rnbiometrics.security.util.DerOutputStream out = new com.rnbiometrics.security.util.DerOutputStream();
            ...
            out.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, tmp);
    ...
    throws CertificateExpiredException, CertificateNotYetValidException {
        ...
        com.rnbiometrics.security.x509.CertificateValidity interval = null;
        try {
            interval = (com.rnbiometrics.security.x509.CertificateValidity)info.get(com.rnbiometrics.security.x509.CertificateValidity.NAME);
        } catch (Exception e) {
    ...
    throws CertificateException, IOException {
        ...
        if (id.equalsIgnoreCase(INFO)) {
            if (attr.getSuffix() == null) {
                if (!(obj instanceof com.rnbiometrics.security.x509.X509CertInfo)) {
                    throw new CertificateException("Attribute value should"
                                    + " be of type X509CertInfo.");
                }
                info = (com.rnbiometrics.security.x509.X509CertInfo)obj;
    ...
    public PublicKey getPublicKey() {
        if (info == null)
            return null;
        try {
            PublicKey key = (PublicKey)info.get(com.rnbiometrics.security.x509.CertificateX509Key.NAME
    ...
    public int getVersion() {
        if (info == null)
            return -1;
        try {
            int vers = ((Integer)info.get(com.rnbiometrics.security.x509.CertificateVersion.NAME
    ...
    public BigInteger getSerialNumber() {
        com.rnbiometrics.security.x509.SerialNumber ser = getSerialNumberObject();
     ...
     * @return the serial number.
     */
    public com.rnbiometrics.security.x509.SerialNumber getSerialNumberObject() {
        if (info == null)
            return null;
        try {
            com.rnbiometrics.security.x509.SerialNumber ser = (SerialNumber)info.get(
                              com.rnbiometrics.security.x509.CertificateSerialNumber.NAME + DOT +
    ...
    public Principal getSubjectDN() {
        ...
        try {
            Principal subject = (Principal)info.get(
                                 com.rnbiometrics.security.x509.CertificateSubjectName.NAME + DOT +
                                 com.rnbiometrics.security.x509.CertificateSubjectName.DN_NAME);
            return subject;
        } catch (Exception e) {
            return null;
    ...
    public Principal getIssuerDN() {
        ...
        try {
            Principal issuer = (Principal)info.get(
                                com.rnbiometrics.security.x509.CertificateIssuerName.NAME + DOT +
                                com.rnbiometrics.security.x509.CertificateIssuerName.DN_NAME);
            return issuer;
        } catch (Exception e) {
            return null;
    ...
    public Date getNotBefore() {
        if (info == null)
            return null;
        try {
            Date d = (Date) info.get(com.rnbiometrics.security.x509.CertificateValidity.NAME + DOT +
                                        com.rnbiometrics.security.x509.CertificateValidity.NOT_BEFORE);
            return d;
        } catch (Exception e) {
            return null;
        }
    ...
    public String getSigAlgOID() {
        if (algId == null)
            return null;
        com.rnbiometrics.security.util.ObjectIdentifier oid = algId.getOID();
        return (oid.toString());
    }
    ...
    public boolean[] getIssuerUniqueID() {
        if (info == null)
            return null;
        try {
            com.rnbiometrics.security.x509.UniqueIdentity id = (com.rnbiometrics.security.x509.UniqueIdentity)info.get(
    ...
    public boolean[] getSubjectUniqueID() {
        if (info == null)
            return null;
        try {
            com.rnbiometrics.security.x509.UniqueIdentity id = (UniqueIdentity)info.get(
     ...
     * in certificate)
     */
    public com.rnbiometrics.security.x509.AuthorityKeyIdentifierExtension getAuthorityKeyIdentifierExtension()
    {
        return (AuthorityKeyIdentifierExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.AuthorityKey_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.BasicConstraintsExtension getBasicConstraintsExtension() {
        return (com.rnbiometrics.security.x509.BasicConstraintsExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.BasicConstraints_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.CertificatePoliciesExtension getCertificatePoliciesExtension() {
        return (CertificatePoliciesExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.CertificatePolicies_Id);
    }
     ...
     * in certificate)
     */
    public com.rnbiometrics.security.x509.ExtendedKeyUsageExtension getExtendedKeyUsageExtension() {
        return (com.rnbiometrics.security.x509.ExtendedKeyUsageExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.ExtendedKeyUsage_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.IssuerAlternativeNameExtension getIssuerAlternativeNameExtension() {
        return (com.rnbiometrics.security.x509.IssuerAlternativeNameExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.IssuerAlternativeName_Id);
    }
     ...
     */
    public com.rnbiometrics.security.x509.NameConstraintsExtension getNameConstraintsExtension() {
        return (NameConstraintsExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.NameConstraints_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.PolicyConstraintsExtension getPolicyConstraintsExtension() {
        return (PolicyConstraintsExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.PolicyConstraints_Id);
    }
     ...
     * in certificate)
     */
    public com.rnbiometrics.security.x509.PolicyMappingsExtension getPolicyMappingsExtension() {
        return (PolicyMappingsExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.PolicyMappings_Id);
    }
     ...
     */
    public com.rnbiometrics.security.x509.PrivateKeyUsageExtension getPrivateKeyUsageExtension() {
        return (PrivateKeyUsageExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.PrivateKeyUsage_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.SubjectAlternativeNameExtension getSubjectAlternativeNameExtension()
    {
        return (com.rnbiometrics.security.x509.SubjectAlternativeNameExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.SubjectAlternativeName_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.SubjectKeyIdentifierExtension getSubjectKeyIdentifierExtension() {
        return (SubjectKeyIdentifierExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.SubjectKey_Id);
    }
     ...
     * certificate)
     */
    public com.rnbiometrics.security.x509.CRLDistributionPointsExtension getCRLDistributionPointsExtension() {
        return (CRLDistributionPointsExtension)
            getExtension(com.rnbiometrics.security.x509.PKIXExtensions.CRLDistributionPoints_Id);
    }
    ...
    public boolean hasUnsupportedCriticalExtension() {
        if (info == null)
            return false;
        try {
            com.rnbiometrics.security.x509.CertificateExtensions exts = (com.rnbiometrics.security.x509.CertificateExtensions)info.get(
                                         com.rnbiometrics.security.x509.CertificateExtensions.NAME);
            if (exts == null)
                return false;
    ...
    public Set<String> getCriticalExtensionOIDs() {
        ...
        try {
            ...
            for (com.rnbiometrics.security.x509.Extension ex : exts.getAllExtensions()) {
                if (ex.isCritical()) {
     ...
     *         extension
     */
    public com.rnbiometrics.security.x509.Extension getExtension(com.rnbiometrics.security.util.ObjectIdentifier oid) {
        if (info == null) {
            return null;
        }
        try {
            com.rnbiometrics.security.x509.CertificateExtensions extensions;
            try {
                extensions = (com.rnbiometrics.security.x509.CertificateExtensions)info.get(com.rnbiometrics.security.x509.CertificateExtensions.NAME);
            ...
            if (extensions == null) {
                ...
                for (com.rnbiometrics.security.x509.Extension ex : extensions.getAllExtensions()) {
    ...
    public com.rnbiometrics.security.x509.Extension getUnparseableExtension(com.rnbiometrics.security.util.ObjectIdentifier oid) {
        if (info == null) {
            return null;
        }
        try {
    ...
    public byte[] getExtensionValue(String oid) {
        try {
            com.rnbiometrics.security.util.ObjectIdentifier findOID = new com.rnbiometrics.security.util.ObjectIdentifier(oid);
            String extAlias = com.rnbiometrics.security.x509.OIDMap.getName(findOID);
            com.rnbiometrics.security.x509.Extension certExt = null;
            com.rnbiometrics.security.x509.CertificateExtensions exts = (com.rnbiometrics.security.x509.CertificateExtensions)info.get(
            ...
            if (extAlias == null) { // may be unknown
                ...
                for (com.rnbiometrics.security.x509.Extension ex : exts.getAllExtensions()) {
                    com.rnbiometrics.security.util.ObjectIdentifier inCertOID = ex.getExtensionId();
...
//                    certExt = (Extension)this.get(extAlias);
                    certExt = (com.rnbiometrics.security.x509.Extension) this.get(extAlias);
                } catch (CertificateException e) {
    ...
    public boolean[] getKeyUsage() {
        try {
            String extAlias = com.rnbiometrics.security.x509.OIDMap.getName(com.rnbiometrics.security.x509.PKIXExtensions.KeyUsage_Id);
            if (extAlias == null)
                return null;

            com.rnbiometrics.security.x509.KeyUsageExtension certExt = (KeyUsageExtension)this.get(extAlias);
            if (certExt == null)
                return null;
    ...
    public synchronized List<String> getExtendedKeyUsage()
        ...
        if (readOnly && extKeyUsage != null) {
            ...
            com.rnbiometrics.security.x509.ExtendedKeyUsageExtension ext = getExtendedKeyUsageExtension();
            if (ext == null) {
                return null;
            }
            extKeyUsage =
    ...
    public static List<String> getExtendedKeyUsage(X509Certificate cert)
        ...
        try {
            ...
            if (ext == null)
                return null;
            com.rnbiometrics.security.util.DerValue val = new com.rnbiometrics.security.util.DerValue(ext);
            byte[] data = val.getOctetString();

            com.rnbiometrics.security.x509.ExtendedKeyUsageExtension ekuExt =
    ...
    public int getBasicConstraints() {
        try {
            String extAlias = OIDMap.getName(com.rnbiometrics.security.x509.PKIXExtensions.BasicConstraints_Id);
            if (extAlias == null)
                return -1;
            com.rnbiometrics.security.x509.BasicConstraintsExtension certExt =
                        (com.rnbiometrics.security.x509.BasicConstraintsExtension)this.get(extAlias);
            if (certExt == null)
                return -1;

            if (((Boolean)certExt.get(com.rnbiometrics.security.x509.BasicConstraintsExtension.IS_CA)
                 ).booleanValue() == true)
     ...
     */
    private static Collection<List<?>> makeAltNames(com.rnbiometrics.security.x509.GeneralNames names) {
        if (names.isEmpty()) {
            return Collections.<List<?>>emptySet();
        }
        Set<List<?>> newNames = new HashSet<List<?>>();
        for (GeneralName gname : names.names()) {
            com.rnbiometrics.security.x509.GeneralNameInterface name = gname.getName();
            List<Object> nameEntry = new ArrayList<Object>(2);
            nameEntry.add(Integer.valueOf(name.getType()));
            switch (name.getType()) {
            case com.rnbiometrics.security.x509.GeneralNameInterface.NAME_RFC822:
                nameEntry.add(((RFC822Name) name).getName());
                break;
            case com.rnbiometrics.security.x509.GeneralNameInterface.NAME_DNS:
                nameEntry.add(((DNSName) name).getName());
                break;
            case com.rnbiometrics.security.x509.GeneralNameInterface.NAME_DIRECTORY:
                nameEntry.add(((X500Name) name).getRFC2253Name());
                break;
            case com.rnbiometrics.security.x509.GeneralNameInterface.NAME_URI:
                nameEntry.add(((URIName) name).getName());
                break;
            case com.rnbiometrics.security.x509.GeneralNameInterface.NAME_IP:
                try {
            ...
            default:
                ...
                com.rnbiometrics.security.util.DerOutputStream derOut = new com.rnbiometrics.security.util.DerOutputStream();
                try {
                    name.encode(derOut);
                } catch (IOException ioe) {
    ...
    public synchronized Collection<List<?>> getSubjectAlternativeNames()
        ...
        com.rnbiometrics.security.x509.SubjectAlternativeNameExtension subjectAltNameExt =
            getSubjectAlternativeNameExtension();
        if (subjectAltNameExt == null) {
            return null;
        }
        com.rnbiometrics.security.x509.GeneralNames names;
        try {
            names = (com.rnbiometrics.security.x509.GeneralNames) subjectAltNameExt.get
                (com.rnbiometrics.security.x509.SubjectAlternativeNameExtension.SUBJECT_NAME);
        } catch (IOException ioe) {
            // should not occur
            return Collections.<List<?>>emptySet();
        }
    ...
    public static Collection<List<?>> getSubjectAlternativeNames(X509Certificate cert)
        ...
        try {
            ...
            com.rnbiometrics.security.x509.SubjectAlternativeNameExtension subjectAltNameExt =
                new com.rnbiometrics.security.x509.SubjectAlternativeNameExtension(Boolean.FALSE,
                                                    data);
    ...
    public synchronized Collection<List<?>> getIssuerAlternativeNames()
        ...
        com.rnbiometrics.security.x509.IssuerAlternativeNameExtension issuerAltNameExt =
        ...
        com.rnbiometrics.security.x509.GeneralNames names;
        try {
            names = (com.rnbiometrics.security.x509.GeneralNames) issuerAltNameExt.get
                (com.rnbiometrics.security.x509.IssuerAlternativeNameExtension.ISSUER_NAME);
        } catch (IOException ioe) {
            // should not occur
            return Collections.<List<?>>emptySet();
        }
    ...
    public static Collection<List<?>> getIssuerAlternativeNames(X509Certificate cert)
        ...
        try {
            ...
            com.rnbiometrics.security.x509.IssuerAlternativeNameExtension issuerAltNameExt =
                new com.rnbiometrics.security.x509.IssuerAlternativeNameExtension(Boolean.FALSE,
                                                    data);
            com.rnbiometrics.security.x509.GeneralNames names;
            try {
    ...
    public com.rnbiometrics.security.x509.AuthorityInfoAccessExtension getAuthorityInfoAccessExtension() {
     ...
     */
    private void parse(com.rnbiometrics.security.util.DerValue val)
    throws CertificateException, IOException {
        ...
        if (val.data == null || val.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence)
            throw new CertificateParsingException(
                      "invalid DER-encoded certificate data");

        signedCert = val.toByteArray();
        DerValue[] seq = new com.rnbiometrics.security.util.DerValue[3];
        ...
        if (seq[0].tag != com.rnbiometrics.security.util.DerValue.tag_Sequence) {
            throw new CertificateParsingException("signed fields invalid");
        }

        algId = com.rnbiometrics.security.x509.AlgorithmId.parse(seq[1]);
        ...
        com.rnbiometrics.security.x509.AlgorithmId infoSigAlg = (AlgorithmId)info.get(
                                              com.rnbiometrics.security.x509.CertificateAlgorithmId.NAME
                                              + DOT +
    ...
    private static X500Principal getX500Principal(X509Certificate cert,
        ...
        com.rnbiometrics.security.util.DerInputStream derIn = new com.rnbiometrics.security.util.DerInputStream(encoded);
        com.rnbiometrics.security.util.DerValue tbsCert = derIn.getSequence(3)[0];
        com.rnbiometrics.security.util.DerInputStream tbsIn = tbsCert.data;
        com.rnbiometrics.security.util.DerValue tmp;
