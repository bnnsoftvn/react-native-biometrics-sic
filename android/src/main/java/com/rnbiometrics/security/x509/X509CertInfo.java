...
public class X509CertInfo implements CertAttrSet<String> {
    ...
    public static final String VERSION = com.rnbiometrics.security.x509.CertificateVersion.NAME;
    public static final String SERIAL_NUMBER = com.rnbiometrics.security.x509.CertificateSerialNumber.NAME;
    public static final String ALGORITHM_ID = com.rnbiometrics.security.x509.CertificateAlgorithmId.NAME;
    public static final String ISSUER = com.rnbiometrics.security.x509.CertificateIssuerName.NAME;
    public static final String VALIDITY = com.rnbiometrics.security.x509.CertificateValidity.NAME;
    public static final String SUBJECT = com.rnbiometrics.security.x509.CertificateSubjectName.NAME;
    public static final String KEY = com.rnbiometrics.security.x509.CertificateX509Key.NAME;
    ...
    public static final String EXTENSIONS = com.rnbiometrics.security.x509.CertificateExtensions.NAME;

    // X509.v1 data
    protected com.rnbiometrics.security.x509.CertificateVersion version = new com.rnbiometrics.security.x509.CertificateVersion();
    protected com.rnbiometrics.security.x509.CertificateSerialNumber serialNum = null;
    protected com.rnbiometrics.security.x509.CertificateAlgorithmId algId = null;
    protected com.rnbiometrics.security.x509.CertificateIssuerName issuer = null;
    protected com.rnbiometrics.security.x509.CertificateValidity interval = null;
    protected com.rnbiometrics.security.x509.CertificateSubjectName subject = null;
    protected com.rnbiometrics.security.x509.CertificateX509Key pubKey = null;
    ...
    // X509.v3 extensions
    protected com.rnbiometrics.security.x509.CertificateExtensions extensions = null;
    ...
    public X509CertInfo(byte[] cert) throws CertificateParsingException {
        try {
            com.rnbiometrics.security.util.DerValue in = new com.rnbiometrics.security.util.DerValue(cert);
     ...
     * @exception CertificateParsingException on parsing errors.
     */
    public X509CertInfo(com.rnbiometrics.security.util.DerValue derVal) throws CertificateParsingException {
        try {
            parse(derVal);
        } catch (IOException e) {
            CertificateParsingException parseException =
    ...
    public String toString() {
        ...
        if (extensions != null) {
            ...
            Map<String, com.rnbiometrics.security.x509.Extension> invalid = extensions.getUnparseableExtensions();
            if (invalid.isEmpty() == false) {
                sb.append("\nUnparseable certificate extensions: " + invalid.size());
                int i = 1;
                for (com.rnbiometrics.security.x509.Extension ext : invalid.values()) {
                    sb.append("\n[" + (i++) + "]: ");
                    sb.append(ext);
                }
            }
    ...
    throws CertificateException, IOException {
        com.rnbiometrics.security.x509.X509AttributeName attrName = new com.rnbiometrics.security.x509.X509AttributeName(name);
        ...
        case ATTR_EXTENSIONS:
            if (suffix == null) {
                ...
                if (extensions == null)
                    extensions = new com.rnbiometrics.security.x509.CertificateExtensions();
    ...
    throws CertificateException, IOException {
        com.rnbiometrics.security.x509.X509AttributeName attrName = new X509AttributeName(name);
    ...
    throws CertificateParsingException, IOException {
        com.rnbiometrics.security.util.DerInputStream in;
        ...
        if (tmp.isContextSpecific((byte)0)) {
            version = new com.rnbiometrics.security.x509.CertificateVersion(tmp);
            tmp = in.getDerValue();
        }

        // Serial number ... an integer
        serialNum = new com.rnbiometrics.security.x509.CertificateSerialNumber(tmp);

        // Algorithm Identifier
        algId = new com.rnbiometrics.security.x509.CertificateAlgorithmId(in);

        // Issuer name
        issuer = new com.rnbiometrics.security.x509.CertificateIssuerName(in);
        com.rnbiometrics.security.x509.X500Name issuerDN = (com.rnbiometrics.security.x509.X500Name)issuer.get(com.rnbiometrics.security.x509.CertificateIssuerName.DN_NAME);
        if (issuerDN.isEmpty()) {
            throw new CertificateParsingException(
        ...
        interval = new com.rnbiometrics.security.x509.CertificateValidity(in);

        // subject name
        subject = new com.rnbiometrics.security.x509.CertificateSubjectName(in);
        com.rnbiometrics.security.x509.X500Name subjectDN = (com.rnbiometrics.security.x509.X500Name)subject.get(com.rnbiometrics.security.x509.CertificateSubjectName.DN_NAME);
        if ((version.compare(com.rnbiometrics.security.x509.CertificateVersion.V1) == 0) &&
                subjectDN.isEmpty()) {
            throw new CertificateParsingException(
        ...
        // public key
        pubKey = new com.rnbiometrics.security.x509.CertificateX509Key(in);
        ...
        // Get the extensions.
        if (version.compare(com.rnbiometrics.security.x509.CertificateVersion.V3) != 0) {
            throw new CertificateParsingException(
                      "Extensions not allowed in v2 certificate");
        }
        if (tmp.isConstructed() && tmp.isContextSpecific((byte)3)) {
            extensions = new com.rnbiometrics.security.x509.CertificateExtensions(tmp.data);
        }
     ...
     */
    private void verifyCert(com.rnbiometrics.security.x509.CertificateSubjectName subject,
        ...
        com.rnbiometrics.security.x509.X500Name subjectDN = (X500Name)subject.get(com.rnbiometrics.security.x509.CertificateSubjectName.DN_NAME);
        if (subjectDN.isEmpty()) {
            ...
            com.rnbiometrics.security.x509.SubjectAlternativeNameExtension subjectAltNameExt = null;
            com.rnbiometrics.security.x509.SubjectAlternativeNameExtension extValue = null;
            com.rnbiometrics.security.x509.GeneralNames names = null;
            try {
                subjectAltNameExt = (com.rnbiometrics.security.x509.SubjectAlternativeNameExtension)
                        extensions.get(com.rnbiometrics.security.x509.SubjectAlternativeNameExtension.NAME);
     ...
     */
    private void emit(com.rnbiometrics.security.util.DerOutputStream out)
    throws CertificateException, IOException {
        com.rnbiometrics.security.util.DerOutputStream tmp = new com.rnbiometrics.security.util.DerOutputStream();
    ...
    private void setVersion(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateVersion)) {
            throw new CertificateException("Version class type invalid.");
        }
        version = (com.rnbiometrics.security.x509.CertificateVersion)val;
    }
    ...
    private void setSerialNumber(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateSerialNumber)) {
    ...
    private void setAlgorithmId(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateAlgorithmId)) {
    ...
    private void setIssuer(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateIssuerName)) {
            throw new CertificateException(
    ...
    private void setValidity(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateValidity)) {
            throw new CertificateException(
    ...
    private void setSubject(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateSubjectName)) {
            throw new CertificateException(
    ...
    private void setKey(Object val) throws CertificateException {
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateX509Key)) {
            throw new CertificateException(
    ...
    private void setIssuerUniqueId(Object val) throws CertificateException {
        if (version.compare(com.rnbiometrics.security.x509.CertificateVersion.V2) < 0) {
    ...
    private void setExtensions(Object val) throws CertificateException {
        ...
        if (!(val instanceof com.rnbiometrics.security.x509.CertificateExtensions)) {
          throw new CertificateException(
