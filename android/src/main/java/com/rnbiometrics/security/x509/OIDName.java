 ...
 */
public class OIDName implements com.rnbiometrics.security.x509.GeneralNameInterface {
     ...
     */
    public OIDName(com.rnbiometrics.security.util.ObjectIdentifier oid) {
        this.oid = oid;
    }
    ...
    public OIDName(String name) throws IOException {
        try {
            oid = new com.rnbiometrics.security.util.ObjectIdentifier(name);
        } catch (Exception e) {
     ...
     */
    public int getType() {
        return (com.rnbiometrics.security.x509.GeneralNameInterface.NAME_OID);
    }
