...
public class DistributionPointName {
    ...
    private com.rnbiometrics.security.x509.GeneralNames fullName = null;
    private com.rnbiometrics.security.x509.RDN relativeName = null;
     ...
     */
    public DistributionPointName(com.rnbiometrics.security.x509.GeneralNames fullName) {
     ...
     */
    public DistributionPointName(com.rnbiometrics.security.x509.RDN relativeName) {
    ...
    public DistributionPointName(DerValue encoding) throws IOException {
        ...
        if (encoding.isContextSpecific(TAG_FULL_NAME) &&
            ...
            fullName = new com.rnbiometrics.security.x509.GeneralNames(encoding);

        } else if (encoding.isContextSpecific(TAG_RELATIVE_NAME) &&
            encoding.isConstructed()) {

            encoding.resetTag(DerValue.tag_Set);
            relativeName = new com.rnbiometrics.security.x509.RDN(encoding);
