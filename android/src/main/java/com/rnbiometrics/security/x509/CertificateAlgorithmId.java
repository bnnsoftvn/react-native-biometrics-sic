...
public class CertificateAlgorithmId implements CertAttrSet<String> {
    private com.rnbiometrics.security.x509.AlgorithmId algId;
     ...
     * @see com.rnbiometrics.security.x509.AlgorithmId
     */
     ...
     */
    public CertificateAlgorithmId(com.rnbiometrics.security.x509.AlgorithmId algId) {
        this.algId = algId;
    }
     ...
     */
    public CertificateAlgorithmId(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
        DerValue val = in.getDerValue();
        algId = com.rnbiometrics.security.x509.AlgorithmId.parse(val);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof com.rnbiometrics.security.x509.AlgorithmId)) {
