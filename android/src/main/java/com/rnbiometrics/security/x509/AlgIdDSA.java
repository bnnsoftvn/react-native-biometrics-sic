...
class AlgIdDSA extends AlgorithmId implements DSAParams
{
    ...
    public AlgIdDSA (byte[] encodedAlg) throws IOException
        { super (new com.rnbiometrics.security.util.DerValue(encodedAlg).getOID()); }
    ...
    throws IOException
    {
        ...
        out.putInteger(q);
        out.putInteger(g);
        params = new com.rnbiometrics.security.util.DerValue(com.rnbiometrics.security.util.DerValue.tag_Sequence,out.toByteArray ());
    }
    ...
    throws IOException
    {
        ...
        if (params.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence)
    ...
    protected String paramsToString ()
    {
        if (params == null)
            ...
            return
                "\n    p:\n" + com.rnbiometrics.security.util.Debug.toHexString(p) +
                "\n    q:\n" + com.rnbiometrics.security.util.Debug.toHexString(q) +
                "\n    g:\n" + com.rnbiometrics.security.util.Debug.toHexString(g) +
                "\n";
    }
}
