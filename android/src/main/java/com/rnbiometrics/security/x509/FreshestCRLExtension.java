...
public class FreshestCRLExtension extends CRLDistributionPointsExtension {
    ...
    public FreshestCRLExtension(List<DistributionPoint> distributionPoints)
        ...
        super(com.rnbiometrics.security.x509.PKIXExtensions.FreshestCRL_Id, false, distributionPoints, NAME);
    }
    ...
    throws IOException {
        super(com.rnbiometrics.security.x509.PKIXExtensions.FreshestCRL_Id, critical.booleanValue(), value,
            NAME);
    }
