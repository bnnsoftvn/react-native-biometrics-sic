...
public class GeneralSubtree {
    ...
    private com.rnbiometrics.security.x509.GeneralName name;
     ...
     */
    public GeneralSubtree(com.rnbiometrics.security.x509.GeneralName name, int min, int max) {
        this.name = name;
        this.minimum = min;
        this.maximum = max;
    }
     ...
     */
    public GeneralSubtree(com.rnbiometrics.security.util.DerValue val) throws IOException {
        if (val.tag != com.rnbiometrics.security.util.DerValue.tag_Sequence) {
            throw new IOException("Invalid encoding for GeneralSubtree.");
        }
        name = new com.rnbiometrics.security.x509.GeneralName(val.data.getDerValue(), true);
    ...
    public void encode(com.rnbiometrics.security.util.DerOutputStream out) throws IOException {
        DerOutputStream seq = new com.rnbiometrics.security.util.DerOutputStream();
        ...
        if (minimum != MIN_DEFAULT) {
            ...
            seq.writeImplicit(com.rnbiometrics.security.util.DerValue.createTag(com.rnbiometrics.security.util.DerValue.TAG_CONTEXT,
                              false, TAG_MIN), tmp);
        }
        if (maximum != -1) {
            com.rnbiometrics.security.util.DerOutputStream tmp = new com.rnbiometrics.security.util.DerOutputStream();
        ...
        out.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, seq);
    }
}
