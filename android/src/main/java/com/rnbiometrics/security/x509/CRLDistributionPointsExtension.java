 ...
 * @since 1.4.2
 * @see com.rnbiometrics.security.x509.DistributionPoint
...
public class CRLDistributionPointsExtension extends Extension
     ...
     */
    private List<com.rnbiometrics.security.x509.DistributionPoint> distributionPoints;
    ...
    public CRLDistributionPointsExtension(
        List<com.rnbiometrics.security.x509.DistributionPoint> distributionPoints) throws IOException {
    ...
    public CRLDistributionPointsExtension(boolean isCritical,
        ...
        this(com.rnbiometrics.security.x509.PKIXExtensions.CRLDistributionPoints_Id, isCritical,
    ...
    protected CRLDistributionPointsExtension(ObjectIdentifier extensionId,
        boolean isCritical, List<com.rnbiometrics.security.x509.DistributionPoint> distributionPoints,
    ...
    public CRLDistributionPointsExtension(Boolean critical, Object value)
            throws IOException {
        this(com.rnbiometrics.security.x509.PKIXExtensions.CRLDistributionPoints_Id, critical, value, NAME);
    }
    ...
    protected CRLDistributionPointsExtension(ObjectIdentifier extensionId,
        ...
        distributionPoints = new ArrayList<com.rnbiometrics.security.x509.DistributionPoint>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            com.rnbiometrics.security.x509.DistributionPoint point = new com.rnbiometrics.security.x509.DistributionPoint(seq);
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(POINTS)) {
            ...
            distributionPoints = (List<com.rnbiometrics.security.x509.DistributionPoint>)obj;
        } else {
