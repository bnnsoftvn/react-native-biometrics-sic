...
public class CertificateSerialNumber implements CertAttrSet<String> {
    ...
    private com.rnbiometrics.security.x509.SerialNumber serial;
    ...
    public CertificateSerialNumber(BigInteger num) {
      this.serial = new com.rnbiometrics.security.x509.SerialNumber(num);
    }
     ...
     */
    public CertificateSerialNumber(com.rnbiometrics.security.util.DerInputStream in) throws IOException {
        serial = new com.rnbiometrics.security.x509.SerialNumber(in);
    }
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateSerialNumber(com.rnbiometrics.security.util.DerValue val) throws IOException {
        serial = new com.rnbiometrics.security.x509.SerialNumber(val);
    }
