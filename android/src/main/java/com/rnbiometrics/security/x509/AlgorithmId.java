...
import com.rnbiometrics.security.ec.ECKeyFactory;
import com.rnbiometrics.security.util.ObjectIdentifier;
 ...
 */
public class AlgorithmId implements Serializable, com.rnbiometrics.security.util.DerEncoder {
     ...
     */
    private com.rnbiometrics.security.util.ObjectIdentifier algid;
     ...
     */
    protected com.rnbiometrics.security.util.DerValue params;
     ...
     */
    public AlgorithmId(com.rnbiometrics.security.util.ObjectIdentifier oid) {
        algid = oid;
    }
     ...
     */
    public AlgorithmId(com.rnbiometrics.security.util.ObjectIdentifier oid, AlgorithmParameters algparams) {
        algid = oid;
        algParams = algparams;
        constructedFromDer = false;
    }

    private AlgorithmId(com.rnbiometrics.security.util.ObjectIdentifier oid, com.rnbiometrics.security.util.DerValue params)
            throws IOException {
        this.algid = oid;
        this.params = params;
        if (this.params != null) {
     ...
     */
    public final void encode(com.rnbiometrics.security.util.DerOutputStream out) throws IOException {
        derEncode(out);
    }
    ...
    public void derEncode (OutputStream out) throws IOException {
        com.rnbiometrics.security.util.DerOutputStream bytes = new com.rnbiometrics.security.util.DerOutputStream();
        ...
        if (constructedFromDer == false) {
            if (algParams != null) {
                params = new com.rnbiometrics.security.util.DerValue(algParams.getEncoded());
            } else {
                params = null;
            }
        }
        ...
        tmp.write(com.rnbiometrics.security.util.DerValue.tag_Sequence, bytes);
     ...
     */
    public final com.rnbiometrics.security.util.ObjectIdentifier getOID () {
        return algid;
    }
        ...
        if ((params != null) && algid.equals(specifiedWithECDSA_oid)) {
            try {
                AlgorithmId paramsId =
                        AlgorithmId.parse(new com.rnbiometrics.security.util.DerValue(getEncodedParams()));
    ...
    public boolean equals(Object other) {
        ...
        } else if (other instanceof com.rnbiometrics.security.util.ObjectIdentifier) {
            return equals((com.rnbiometrics.security.util.ObjectIdentifier) other);
        } else {
            return false;
        }
    }
     ...
     */
    public final boolean equals(com.rnbiometrics.security.util.ObjectIdentifier id) {
     ...
     */
    public static AlgorithmId parse(com.rnbiometrics.security.util.DerValue val) throws IOException {
         ...
         */
        com.rnbiometrics.security.util.ObjectIdentifier algid;
        com.rnbiometrics.security.util.DerValue params;
        com.rnbiometrics.security.util.DerInputStream in = val.toDerInputStream();
        ...
        if (in.available() == 0) {
            ...
            if (params.tag == com.rnbiometrics.security.util.DerValue.tag_Null) {
                if (params.length() != 0) {
    ...
    public static AlgorithmId get(String algname)
            throws NoSuchAlgorithmException {
        com.rnbiometrics.security.util.ObjectIdentifier oid;
        try {
            oid = algOID(algname);
     ...
     */
    private static com.rnbiometrics.security.util.ObjectIdentifier algOID(String name) throws IOException {
        // See if algname is in printable OID ("dot-dot") notation
        if (name.indexOf('.') != -1) {
            if (name.startsWith("OID.")) {
                return new com.rnbiometrics.security.util.ObjectIdentifier(name.substring("OID.".length()));
            } else {
                return new com.rnbiometrics.security.util.ObjectIdentifier(name);
            }
        }
        ...
        if (!initOidTable) {
            ...
            for (int i=0; i<provs.length; i++) {
                for (Enumeration<Object> enum_ = provs[i].keys();
                    ...
                    if (upperCaseAlias.startsWith("ALG.ALIAS") &&
                        ...
                        if (oidTable == null) {
                            oidTable = new HashMap<String, com.rnbiometrics.security.util.ObjectIdentifier>();
                        }
                        ...
                        if (stdAlgName != null &&
                            ...
                            oidTable.put(stdAlgName,
                                         new com.rnbiometrics.security.util.ObjectIdentifier(oidString));
                        }
                    }
                }
            }
            ...
            if (oidTable == null) {
                oidTable = new HashMap<String, com.rnbiometrics.security.util.ObjectIdentifier>(1);
            }
            initOidTable = true;
        }
    ...
    private static com.rnbiometrics.security.util.ObjectIdentifier oid(int ... values) {
        return com.rnbiometrics.security.util.ObjectIdentifier.newInternal(values);
    }

    private static boolean initOidTable = false;
    private static Map<String, com.rnbiometrics.security.util.ObjectIdentifier> oidTable;
    private static final Map<com.rnbiometrics.security.util.ObjectIdentifier,String> nameTable;
     ...
     */
    public static final com.rnbiometrics.security.util.ObjectIdentifier MD2_oid =
    com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 2, 2});

    /**
     * Algorithm ID for the MD5 Message Digest Algorthm, from RFC 1321.
     * OID = 1.2.840.113549.2.5
     */
    public static final com.rnbiometrics.security.util.ObjectIdentifier MD5_oid =
    com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 2, 5});
     ...
     */
    public static final com.rnbiometrics.security.util.ObjectIdentifier SHA_oid =
    com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 3, 14, 3, 2, 26});

    public static final com.rnbiometrics.security.util.ObjectIdentifier SHA256_oid =
    com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {2, 16, 840, 1, 101, 3, 4, 2, 1});

    public static final com.rnbiometrics.security.util.ObjectIdentifier SHA384_oid =
    com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {2, 16, 840, 1, 101, 3, 4, 2, 2});

    public static final com.rnbiometrics.security.util.ObjectIdentifier SHA512_oid =
    com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {2, 16, 840, 1, 101, 3, 4, 2, 3});
    ...
    public static final com.rnbiometrics.security.util.ObjectIdentifier DH_PKIX_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier DSA_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier DSA_OIW_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier EC_oid = oid(1, 2, 840, 10045, 2, 1);
    public static final com.rnbiometrics.security.util.ObjectIdentifier RSA_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier RSAEncryption_oid;
    ...
    public static final com.rnbiometrics.security.util.ObjectIdentifier md2WithRSAEncryption_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier md5WithRSAEncryption_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha1WithRSAEncryption_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha1WithRSAEncryption_OIW_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha256WithRSAEncryption_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha384WithRSAEncryption_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha512WithRSAEncryption_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier shaWithDSA_OIW_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha1WithDSA_OIW_oid;
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha1WithDSA_oid;

    public static final com.rnbiometrics.security.util.ObjectIdentifier sha1WithECDSA_oid =
                                            oid(1, 2, 840, 10045, 4, 1);
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha224WithECDSA_oid =
                                            oid(1, 2, 840, 10045, 4, 3, 1);
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha256WithECDSA_oid =
                                            oid(1, 2, 840, 10045, 4, 3, 2);
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha384WithECDSA_oid =
                                            oid(1, 2, 840, 10045, 4, 3, 3);
    public static final com.rnbiometrics.security.util.ObjectIdentifier sha512WithECDSA_oid =
                                            oid(1, 2, 840, 10045, 4, 3, 4);
    public static final com.rnbiometrics.security.util.ObjectIdentifier specifiedWithECDSA_oid =
     ...
     * PKCS#12.
     */
    public static final com.rnbiometrics.security.util.ObjectIdentifier pbeWithMD5AndDES_oid =
        com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[]{1, 2, 840, 113549, 1, 5, 3});
    public static final com.rnbiometrics.security.util.ObjectIdentifier pbeWithMD5AndRC2_oid =
        com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 1, 5, 6});
    public static final com.rnbiometrics.security.util.ObjectIdentifier pbeWithSHA1AndDES_oid =
        com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 1, 5, 10});
    public static final com.rnbiometrics.security.util.ObjectIdentifier pbeWithSHA1AndRC2_oid =
        com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 1, 5, 11});
    public static com.rnbiometrics.security.util.ObjectIdentifier pbeWithSHA1AndDESede_oid =
        com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 1, 12, 1, 3});
    public static com.rnbiometrics.security.util.ObjectIdentifier pbeWithSHA1AndRC2_40_oid =
        com.rnbiometrics.security.util.ObjectIdentifier.newInternal(new int[] {1, 2, 840, 113549, 1, 12, 1, 6});
     ...
     */
        DH_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(DH_data);
     ...
     */
        DH_PKIX_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(DH_PKIX_data);
     ...
     * OID = 1.3.14.3.2.12
     */
        DSA_OIW_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(DSA_OIW_data);
     ...
     */
        DSA_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(DSA_PKIX_data);
     ...
     * OID = 2.5.8.1.1
     */
        RSA_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(RSA_data);
     ...
     */
        RSAEncryption_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(RSAEncryption_data);
     ...
     */
        md2WithRSAEncryption_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(md2WithRSAEncryption_data);
     ...
     */
        md5WithRSAEncryption_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(md5WithRSAEncryption_data);
     ...
     */
        sha1WithRSAEncryption_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(sha1WithRSAEncryption_data);
     ...
     */
        sha1WithRSAEncryption_OIW_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(sha1WithRSAEncryption_OIW_data);
     ...
     */
        sha256WithRSAEncryption_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(sha256WithRSAEncryption_data);
     ...
     */
        sha384WithRSAEncryption_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(sha384WithRSAEncryption_data);
     ...
     */
        sha512WithRSAEncryption_oid =
            com.rnbiometrics.security.util.ObjectIdentifier.newInternal(sha512WithRSAEncryption_data);
     ...
     * OID = 1.3.14.3.2.13
     */
        shaWithDSA_OIW_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(shaWithDSA_OIW_data);
     ...
     * OID = 1.3.14.3.2.27
     */
        sha1WithDSA_OIW_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(sha1WithDSA_OIW_data);
     ...
     */
        sha1WithDSA_oid = com.rnbiometrics.security.util.ObjectIdentifier.newInternal(dsaWithSHA1_PKIX_data);

        nameTable = new HashMap<com.rnbiometrics.security.util.ObjectIdentifier,String>();
