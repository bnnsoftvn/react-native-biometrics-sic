 ...
 */
public class DNSName implements com.rnbiometrics.security.x509.GeneralNameInterface {
    private String name;
     ...
     */
    public DNSName(com.rnbiometrics.security.util.DerValue derValue) throws IOException {
     ...
     */
    public int getType() {
        return (com.rnbiometrics.security.x509.GeneralNameInterface.NAME_DNS);
    }
