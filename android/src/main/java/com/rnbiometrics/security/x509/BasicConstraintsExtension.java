...
implements CertAttrSet<String> {
    ...
    throws IOException {
        this.ca = ca;
        this.pathLen = len;
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.BasicConstraints_Id;
         ...
         throws IOException
    {
         ...
         if (opt.tag != com.rnbiometrics.security.util.DerValue.tag_Boolean) {
             // non-CA cert ("cA" field is FALSE by default), return -1
             return;
         }
         ...
         if (opt.tag != com.rnbiometrics.security.util.DerValue.tag_Integer) {
             throw new IOException("Invalid encoding of BasicConstraints");
         }
