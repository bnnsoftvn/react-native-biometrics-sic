...
extends Extension implements CertAttrSet<String> {
     ...
     */
    public IssuerAlternativeNameExtension(com.rnbiometrics.security.x509.GeneralNames names)
    throws IOException {
        this.names = names;
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.IssuerAlternativeName_Id;
        this.critical = false;
        encodeThis();
    }
     ...
     * @exception IOException on error.
     */
    public IssuerAlternativeNameExtension(Boolean critical, com.rnbiometrics.security.x509.GeneralNames names)
    throws IOException {
        this.names = names;
        this.extensionId = com.rnbiometrics.security.x509.PKIXExtensions.IssuerAlternativeName_Id;
    ...
    public IssuerAlternativeNameExtension() {
        extensionId = com.rnbiometrics.security.x509.PKIXExtensions.IssuerAlternativeName_Id;
        critical = false;
