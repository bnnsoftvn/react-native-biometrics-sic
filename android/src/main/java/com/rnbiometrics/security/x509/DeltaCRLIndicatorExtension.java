...
public class DeltaCRLIndicatorExtension extends CRLNumberExtension {
    ...
    public DeltaCRLIndicatorExtension(int crlNum) throws IOException {
        super(com.rnbiometrics.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true,
    ...
    public DeltaCRLIndicatorExtension(BigInteger crlNum) throws IOException {
        super(com.rnbiometrics.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true, crlNum, NAME, LABEL);
    }
    ...
    throws IOException {
        super(com.rnbiometrics.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, critical.booleanValue(),
            value, NAME, LABEL);
    }
