...
import com.rnbiometrics.misc.IOUtils;
...
public class DerValue {
    ...
    protected com.rnbiometrics.security.util.DerInputBuffer buffer;

    /**
     * The DER-encoded data of the value, never null
     */
    public final com.rnbiometrics.security.util.DerInputStream data;
    ...
    public DerValue(byte tag, byte[] data) {
        this.tag = tag;
        buffer = new com.rnbiometrics.security.util.DerInputBuffer(data.clone());
        length = data.length;
        this.data = new com.rnbiometrics.security.util.DerInputStream(buffer);
     ...
     * package private
     */
    DerValue(com.rnbiometrics.security.util.DerInputBuffer in) throws IOException {
        // XXX must also parse BER-encoded constructed
        // values such as sequences, sets...

        tag = (byte)in.read();
        byte lenByte = (byte)in.read();
        length = com.rnbiometrics.security.util.DerInputStream.getLength((lenByte & 0xff), in);
        if (length == -1) {  // indefinite length encoding found
            com.rnbiometrics.security.util.DerInputBuffer inbuf = in.dup();
            ...
            inbuf = new com.rnbiometrics.security.util.DerInputBuffer(derIn.convert(indefData));
            if (tag != inbuf.read())
                throw new IOException
                        ("Indefinite length encoding not supported");
            length = com.rnbiometrics.security.util.DerInputStream.getLength(inbuf);
            buffer = inbuf.dup();
            buffer.truncate(length);
            data = new com.rnbiometrics.security.util.DerInputStream(buffer);
    ...
    private com.rnbiometrics.security.util.DerInputStream init(byte stringTag, String value) throws IOException {
        String enc = null;
        ...
        length = buf.length;
        buffer = new com.rnbiometrics.security.util.DerInputBuffer(buf);
        com.rnbiometrics.security.util.DerInputStream result = new com.rnbiometrics.security.util.DerInputStream(buffer);
     ...
     * helper routine
     */
    private com.rnbiometrics.security.util.DerInputStream init(boolean fullyBuffered, InputStream in)
            throws IOException {
        ...
        if (length == -1) { // indefinite length encoding found
            ...
            if (tag != in.read())
                throw new IOException
                        ("Indefinite length encoding not supported");
            length = com.rnbiometrics.security.util.DerInputStream.getLength(in);
        }
        ...
        buffer = new com.rnbiometrics.security.util.DerInputBuffer(bytes);
        return new com.rnbiometrics.security.util.DerInputStream(buffer);
    }

    /**
     * Encode an ASN1/DER encoded datum onto a DER output stream.
     */
    public void encode(com.rnbiometrics.security.util.DerOutputStream out)
    throws IOException {
        out.write(tag);
    ...
    public final com.rnbiometrics.security.util.DerInputStream getData() {
        return data;
    }
    ...
    public byte[] getOctetString() throws IOException {
        ...
        if (isConstructed()) {
            com.rnbiometrics.security.util.DerInputStream in = new com.rnbiometrics.security.util.DerInputStream(bytes);
            bytes = null;
    ...
    public byte[] toByteArray() throws IOException {
        com.rnbiometrics.security.util.DerOutputStream out = new DerOutputStream();
