...
class ObjectIdentifier implements Serializable
{
     ...
     */
    public ObjectIdentifier (com.rnbiometrics.security.util.DerInputStream in) throws IOException
    {
        byte    type_id;
        int     bufferEnd;
        ...
        if (type_id != com.rnbiometrics.security.util.DerValue.tag_ObjectId)
     ...
     * Validity check NOT included.
     */
    ObjectIdentifier (com.rnbiometrics.security.util.DerInputBuffer buf) throws IOException
    {
        com.rnbiometrics.security.util.DerInputStream in = new DerInputStream(buf);
