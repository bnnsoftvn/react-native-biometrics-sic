...
class DerInputBuffer extends ByteArrayInputStream implements Cloneable {
     ...
     */
    com.rnbiometrics.security.util.BitArray getUnalignedBitString() throws IOException {
        if (pos >= count)
            return null;
        /*
        ...
        com.rnbiometrics.security.util.BitArray bitArray = new BitArray(length, bits);
        pos = count;
        return bitArray;
    }
